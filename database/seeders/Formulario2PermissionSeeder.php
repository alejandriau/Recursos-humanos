...
class Formulario2PermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Lista de permisos específicos para FORMULARIO2
        $permissions = [
            'ver formularios2',
            'crear formularios2',
            'editar formularios2',
            'eliminar formularios2',
            'gestionar formularios2',
        ];
        ...
        $this->command->info('✅ Permisos de FORMULARIO2 creados y asignados correctamente a los roles.');
    }
}
