...
class BachillerPermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Lista de permisos específicos para BACHILLER
        $permissions = [
            'ver bachilleres',
            'crear bachilleres',
            'editar bachilleres',
            'eliminar bachilleres',
            'gestionar bachilleres',
        ];
        ...
        $this->command->info('✅ Permisos de BACHILLER creados y asignados correctamente a los roles.');
    }
}
