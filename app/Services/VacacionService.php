...
public function generarPeriodosPendientes()
{
    ...
    foreach ($personales as $personal) {
        ...
        $this->procesarVencimientos($personal, $numeroPeriodo);
     ...
     */
    protected function procesarVencimientos(Persona $personal, int $numeroPeriodoActual)
    {
    ...
    /**
     * Obtiene la fecha base real (con CAS o sin él).
     */
/**
