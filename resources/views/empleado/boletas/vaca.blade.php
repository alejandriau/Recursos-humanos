...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        table.doctitle-row { width: 100%; border-collapse: collapse; margin-bottom: 8px; }
        .doctitle {
            font-size: 15px;
            font-weight: bold;
            color: #103a5c;
        ...
        .field .value {
            ...
            color: #263238;
            padding: 2px 0 3px;
            border-bottom: 0.75px solid #e6eaee;
        }
        .field.small .value { font-size: 9.5px; }

        .period-card {
            background: #f4f8fb;
            border: 0.75px solid #dce8f0;
            border-radius: 6px;
            padding: 9px 10px;
            text-align: center;
        }
        ...
        .days-num { font-size: 18px; font-weight: bold; color: #ffffff; }
        .days-txt { font-size: 8px; color: #cfe0ea; text-transform: uppercase; letter-spacing: 0.5px; margin-left: 3px; }

        /* ===== Aprobaciones ===== */
        table.approvals { width: 100%; border-collapse: separate; border-spacing: 8px 0; margin: 0 -8px 8px; }
        table.approvals td {
            width: 50%;
            border: 0.75px solid #e6eaee;
            border-left: 3px solid #c9d3db;
            border-radius: 4px;
            padding: 6px 8px;
            font-size: 9px;
            vertical-align: top;
...
<body>
    <div class="doc">
        ...
        <table class="doctitle-row">
            <tr>
                <td>
                    <span class="doctitle">Boleta de Vacación
                        <span class="doctitle-sub">Autorización electrónica</span>
                    </span>
                </td>
                <td class="doccode">
                    Código de control
            ...
            <tr>
                ...
                <td class="col-period">
                    <div class="period-card">
                        <div class="period-label">Periodo de vacación</div>
                        ...
                        <div class="days-badge">
                            <span class="days-num">{{ $diasSolicitados }}</span>
                            <span class="days-txt">días</span>
                        </div>
                    </div>
                </td>
            </tr>
