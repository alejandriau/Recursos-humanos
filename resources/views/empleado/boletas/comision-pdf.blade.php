...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Contenedor fluido sin altura fija estricta para evitar desbordes */
        .half-page {
            width: 100%;
            padding: 0;
            box-sizing: border-box;
        ...
        table.signatures-table td {
            ...
            vertical-align: top;
            padding: 3px;
            height: 105px; /* Espacio extendido para el QR */
        }
        .sig-header {
            font-size: 7.5px;
            font-weight: bold;
    ...
    <div class="border-container">
        ...
        <table class="form-table">
            <tr>
                ...
                <td class="lbl" style="width: 10%; text-align: right; padding-right: 4px;">Hora:</td>
                <td style="width: 25%;">
            ...
            <tr>
                ...
                <td class="lbl" style="text-align: right; padding-right: 4px;">Hora:</td>
                <td>
                    <div class="box-val" style="text-align: center; font-weight: bold;">
        ...
        <table class="form-table">
            <tr>
                <td class="lbl" style="width: 22%;">Motivo:</td>
                <td style="width: 78%;">
        ...
        <table class="signatures-table">
            <tr>
                ...
                <td style="width: 32%; text-align: center;">
                    ...
                    <!-- QR ampliado y centrado verticalmente -->
