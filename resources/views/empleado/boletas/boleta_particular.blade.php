...
<head>
    <meta charset="UTF-8">
    <style>
        /* dompdf - sin flexbox/grid, usa tablas */
        @page {
            margin: 0.5cm 0.9cm;
        }
...
<body>
    <div class="contenedor">
        ...
        <!-- TÍTULO MODIFICADO PARA SALIDA PARTICULAR -->
        <div class="doc-titulo">BOLETA DE SALIDA PARTICULAR</div>
        ...
        <table class="datos">
            ...
            <tr>
                <td class="etiqueta">Motivo / Sustento:</td>
                <td class="valor">{{ $salida->motivo }}</td>
            </tr>
            <tr>
                <td class="etiqueta">Cantidad (días/horas):</td>
                <td class="valor">{{ $salida->cantidad }}</td>
            </tr>
        </table>

        <!-- APROBACIONES (igual que antes, pero con el flujo de salida particular) -->
