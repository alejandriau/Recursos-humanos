    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
            ...
            <p class="mt-1 max-w-2xl text-sm text-gray-500">
                Modifique la información del puesto de trabajo.
            </p>
        </div>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="denominacion" id="denominacion"
                               value="{{ old('denominacion', $puesto->denominacion) }}"
                    ...
                    <div>
                        ...
                        <select name="tipoContrato" id="tipoContrato"
                            ...
                            <option value="PERMANENTE" {{ old('tipoContrato', $puesto->tipoContrato) == 'PERMANENTE' ? 'selected' : '' }}>Permanente</option>
                            <option value="EVENTUAL" {{ old('tipoContrato', $puesto->tipoContrato) == 'EVENTUAL' ? 'selected' : '' }}>Eventual</option>
                        </select>
                        @error('tipoContrato')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="sm:col-span-2">
                        <div class="flex items-center">
                            <input type="checkbox" name="esJefatura" id="esJefatura"
                                   value="1" {{ old('esJefatura', $puesto->esJefatura) ? 'checked' : '' }}
