...
@section('title', 'Editar Cédula de Identidad')

@section('contenido')
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Editar Cédula de Identidad #{{ $cedula->id }}</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('cedulas.update', $cedula) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                        ...
                        <select class="form-select @error('idPersona') is-invalid @enderror"
                            ...
                            @foreach($personas as $persona)
                                <option value="{{ $persona->id }}"
                                    {{ old('idPersona', $cedula->idPersona) == $persona->id ? 'selected' : '' }}>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('ci') is-invalid @enderror"
                               id="ci" name="ci" value="{{ old('ci', $cedula->ci) }}" maxlength="45"
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('fechanacimiento') is-invalid @enderror"
                               ...
                               value="{{ old('fechanacimiento', $cedula->fechanacimiento ? $cedula->fechanacimiento->format('Y-m-d') : '') }}">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('fechaVencimiento') is-invalid @enderror"
                               ...
                               value="{{ old('fechaVencimiento', $cedula->fechaVencimiento ? $cedula->fechaVencimiento->format('Y-m-d') : '') }}">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('expedido') is-invalid @enderror"
                               id="expedido" name="expedido" value="{{ old('expedido', $cedula->expedido) }}" maxlength="100"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nacido') is-invalid @enderror"
                       id="nacido" name="nacido" value="{{ old('nacido', $cedula->nacido) }}" maxlength="1500"
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('domicilio') is-invalid @enderror"
                          ...
                          placeholder="Dirección completa de domicilio">{{ old('domicilio', $cedula->domicilio) }}</textarea>
                @error('domicilio')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('observacion') is-invalid @enderror"
                          ...
                          placeholder="Observaciones adicionales">{{ old('observacion', $cedula->observacion) }}</textarea>
                @error('observacion')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-text">
                    @if($cedula->pdfcedula)
                        Archivo actual: {{ basename($cedula->pdfcedula) }}
                    @else
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('estado') is-invalid @enderror"
                    ...
                    <option value="1" {{ old('estado', $cedula->estado) == 1 ? 'selected' : '' }}>Activo</option>
                    <option value="0" {{ old('estado', $cedula->estado) == 0 ? 'selected' : '' }}>Inactivo</option>
                </select>
                @error('estado')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
