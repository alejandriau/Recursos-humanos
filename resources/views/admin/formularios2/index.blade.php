...
@section('title', 'Lista de Formularios 2')

@section('contenido')
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Lista de Formularios 2</h5>
        @can('crear formularios2')
        <a href="{{ route('formularios2.create') }}" class="btn btn-primary">
    ...
    <div class="card-body border-bottom">
        <form action="{{ route('formularios2.index') }}" method="GET" class="row g-3">
            <div class="col-md-3">
            ...
            <div class="col-md-2">
                <label for="pdfform2" class="form-label">PDF</label>
                <input type="text" class="form-control" id="pdfform2" name="pdfform2"
                       value="{{ request('pdfform2') }}" placeholder="Buscar PDF...">
            </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ Str::limit($formulario->observacion, 50) }}</td>
                        <td>
                            @if($formulario->pdfform2)
                                <a href="{{ route('formularios2.download', $formulario) }}" class="btn btn-sm btn-success">
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <a href="{{ route('formularios2.show', $formulario) }}" class="btn btn-sm btn-info">
                                    <i class="fas fa-eye"></i>
                                </a>
                                @endcan

                                @can('editar formularios2')
                                <a href="{{ route('formularios2.edit', $formulario) }}" class="btn btn-sm btn-warning">
                                    <i class="fas fa-edit"></i>
                                </a>
                                @endcan

                                @can('eliminar formularios2')
                                <form action="{{ route('formularios2.destroy', $formulario) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                    <tr>
                        <td colspan="7" class="text-center">No hay formularios 2 registrados</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
